...
namespace ATaleOfTwoHorns
{
    class Bunnies : MovingObject
    {
        ...
        public Bunnies(Vector2 initialPosition, Rectangle spriteSourceRectangle, Rectangle spriteDestinationRectangle) :
        ...
        public override void update(Microsoft.Xna.Framework.GameTime gameTime)
        {
            ...
            Vector2 distance = new Vector2(mousePosition.X - m_Position.X, m_Position.Y - mousePosition.Y);
