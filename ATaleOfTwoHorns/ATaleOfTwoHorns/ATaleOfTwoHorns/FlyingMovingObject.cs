...
{
    /// <summary>
    /// base class for a flying moveing object
    /// </summary>
    abstract class FlyingMovingObject : BaseObject
    {
        ...
        public FlyingMovingObject(Vector2 initalPosition, Rectangle spriteSourceRectangle, Rectangle spriteDestinationRectangle) :
